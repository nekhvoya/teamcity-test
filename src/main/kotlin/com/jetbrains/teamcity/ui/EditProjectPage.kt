...
import com.jetbrains.teamcity.config.EnvConfig.Companion.editProjectUrl
...
class EditProjectPage: BasePage(className("editProjectPage"), "Edit Project Page", editProjectUrl) {
