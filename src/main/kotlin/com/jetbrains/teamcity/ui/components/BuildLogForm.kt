...
class BuildLogForm: BaseComponent(By.cssSelector("[aria-label='Build Log']"), "Build Log Form") {
    ...
    fun openStepLog(logText: String) {
        BuildConfigurationPage.log.info("Checking if build overview is visible")
